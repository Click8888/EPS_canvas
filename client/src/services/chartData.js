// Загрузка данных серий (линий) из БД.
// Логика вынесена из Sidebar.js, чтобы переиспользовать её и при импорте
// конфигурации полотна (дозагрузка точек после восстановления узлов).
